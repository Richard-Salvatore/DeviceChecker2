...
local function platform(agent)
    ...
    elseif (string.find(agent, "iOS")) then
        return "iOS"
    elseif (string.find(agent, "Windows") or 
            string.find(agent, "Krampus") or 
            string.find(identifyexecutor(), "Wave") or 
            string.find(identifyexecutor(), "Swift") or 
            string.find(identifyexecutor(), "Xeno") or 
            string.find(identifyexecutor(), "Seline") or 
            string.find(identifyexecutor(), "Atlantis") or 
            string.find(identifyexecutor(), "Zorara") or 
            string.find(identifyexecutor(), "Luna") or 
